...
{
    /// <inheritdoc />
    public partial class InitialSupportRequests : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("p_k_support_requests", x => x.support_request_id);
                })
                .Annotation("MySQL:Charset", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "i_x__m_p_t_m__machine",
                table: "maintenance_plan_template_machines",
                column: "machine_id");

            migrationBuilder.CreateIndex(
                name: "i_x__m_p_t_m__template",
                table: "maintenance_plan_template_machines",
                column: "maintenance_plan_template_id");

            migrationBuilder.CreateIndex(
                name: "i_x__m_p_t_t__template",
